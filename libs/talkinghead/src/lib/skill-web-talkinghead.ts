  ...
  protected async updateMesh(parentMesh: any): Promise<void> {
    ...
    try {
      await head.showAvatar(this.el, parentMesh.el, {
        ...
        avatarMood: this.avatarMood,
        lipsyncLang: this.lipsyncLang,
        avatarMute: this.avatarMute,
        avatarIdleEyeContact: this.avatarIdleEyeContact,
        avatarIdleHeadMove: this.avatarIdleHeadMove,
        avatarSpeakingEyeContact: this.avatarSpeakingEyeContact,
        avatarSpeakingHeadMove: this.avatarSpeakingHeadMove,
      });
    } catch (error) {
      console.log(error);
    }
